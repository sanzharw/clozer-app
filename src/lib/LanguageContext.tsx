...
const translations = {
  ru: {
    ...
    livecall_listening_failed: "Вы не выбрали источник. Попробуйте снова.",
    livecall_stop: "Остановить",
    livecall_start: "Слушать",
    livecall_suggestions_title: "Clozer советует",
    ...
    modal_step_2: "Поставьте галочку \"Поделиться звуком вкладки\"",
    modal_step_3: "Нажмите \"Поделиться\" — Clozer начнёт слушать клиента",
    modal_button: "Понятно, начать",
  ...
  en: {
    ...
    livecall_listening_failed: "Audio source not selected. Try again.",
    livecall_stop: "Stop",
    livecall_start: "Start Listening",
    livecall_suggestions_title: "Clozer Suggests",
    ...
    modal_step_2: "Check the 'Share tab audio' box",
    modal_step_3: "Click 'Share' — Clozer will start listening",
    modal_button: "Got it, Start",
